 let currentSection = 'home';
        ...
        const products = {
            'iPhone 12': {
                'normal': [
                    { id: 1, name: 'Transparente Crystal', price: 25, Image: "img/iphone1.jpg" },
                    { id: 2, name: 'Negro Mate Premium', price: 32, emoji: '⚫' },
                    { id: 3, name: 'Azul Océano', price: 28, emoji: '🌊' },
                    { id: 4, name: 'Rosa Pastel', price: 30, emoji: '🌸' }
                ],
                'pro': [
